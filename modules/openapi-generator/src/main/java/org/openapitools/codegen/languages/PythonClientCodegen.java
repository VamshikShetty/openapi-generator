   ...
   public void processOpts() {
       ...
       if (generateSourceCodeOnly) {
           if(!isSubModule){
               ...
               // tests in <package>/test
               testFolder   = packageName + invokerPackage.replace('.', File.separatorChar) + File.separatorChar + testFolder;
               // api/model docs in <package>/docs
               apiDocPath   = packageName + invokerPackage.replace('.', File.separatorChar) + File.separatorChar +  apiDocPath;
               modelDocPath = packageName + invokerPackage.replace('.', File.separatorChar) + File.separatorChar +  modelDocPath;
           }
       }
       ...
       if (generateSourceCodeOnly) {
           if(!isSubModule){
               ...
               readmePath = packageName + invokerPackage.replace('.', File.separatorChar) + File.separatorChar + readmePath;
           }
       ...
       if(!isSubModule){
           supportingFiles.add(new SupportingFile("empty.mustache", packageName, "submodule_details"));
           ...
           supportingFiles.add(new SupportingFile("__init__package_submodule.mustache", packageName + invokerPackage.replace('.', File.separatorChar), "__init__.py"));
           supportingFiles.add(new SupportingFile("__init__model.mustache", packageName + invokerPackage.replace('.', File.separatorChar) + File.separatorChar + modelPackage, "__init__.py"));
           supportingFiles.add(new SupportingFile("__init__api.mustache", packageName + invokerPackage.replace('.', File.separatorChar)  + File.separatorChar + apiPackage, "__init__.py"));
           
           // If file already exists merge i.e merge API and models data of submodule __init__ with main module __init__
           supportingFiles.add(new SupportingFile("__init__model_submodule.mustache", packageName + File.separatorChar + modelPackage, "__init__.py", true));
           supportingFiles.add(new SupportingFile("__init__api_submodule.mustache", packageName + File.separatorChar + apiPackage, "__init__.py", true));

           supportingFiles.add(new SupportingFile("submodule.mustache", packageName + File.separatorChar, "submodule_details", true));
       }
       ...
       // add name submodule to a file to be used by apiclient to dynamically link with submodules 
